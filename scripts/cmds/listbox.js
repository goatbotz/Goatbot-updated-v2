module.exports = {
  ...
  let owner = [...inbox].filter(group => group.isSubscribed && group.isGroup);

  var aceowner = [];

  for (var groupInfo of owner) {
  ...
  message.reply(msg + '\nReply "out" or "join" the number of order to out or join that thread!', (e, info) =>
